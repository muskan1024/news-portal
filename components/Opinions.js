...
const Opinions = () => {
  return (
    <div className='h-full w-full text-5xl bg-white text-black'>
        <h1 className='font-serif bg-white text-black border-b border-b-black mx-5'><i>Opinions</i></h1>
      <div className=" grid lg:grid-cols-3 grid-cols-2 gap-6 px-12 mt-4  ">
